...
define('SECRET_SALT','OWWVv7y5roc--JlfR6AQLu8-2z6U6Tcf');

#Default admin email. Used only on db connection issues and related alerts.
define('ADMIN_EMAIL','capitallead@capitalbroker.pl');
...
define('DBNAME','patnew_capitallead');
define('DBUSER','patnew_leadsuper');
define('DBPASS','IxPYRfNvMCzp');
