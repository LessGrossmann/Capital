    ...
    <tr>
        <td width="50%">
            <table border="0" cellspacing="" cellpadding="4" width="100%">
                ...
                <tr>
                    <th width="150"><?php echo __('Create Date');?>:</th>
        ...
        <td width="50%" style="vertical-align:top">
            <table border="0" cellspacing="" cellpadding="4" width="100%">
                <tr>
                    ...
                    <td>
					<!--NOLINKUSER <a href="#tickets/< ?php echo $ticket->getId(); ?>/user"
                        onclick="javascript:
                        ...
                        ?></span><!--NOLINKUSER</a>NOLINKUSER--><!--NOLINKUSER
                        <?php
                        if($user) {
                        ...
                        ?>NOLINKUSER-->
                            <!--NOLINKUSER<div id="action-dropdown-stats" class="action-dropdown anchor-right">
                                <ul>
                                    < ?php
    ...
    <tr>
        ...
        <td width="50%">
            <table cellspacing="0" cellpadding="4" width="100%" border="0">
                ...
                if($ticket->isOpen()){ ?>
                <tr>
                    <th width="150"><?php echo __('Due Date');?>:</th>
                    <td><?php echo Format::db_datetime($ticket->getEstDueDate()); ?></td>
                </tr>
                <?php
                }else { ?>
                <tr>
                    <th width="150"><?php echo __('Close Date');?>:</th>
