...
$title=($cfg && is_object($cfg) && $cfg->getTitle())
    ? $cfg->getTitle() : 'CapitalLead :: '.__('Support Ticket System');
...
?>>
<head>
<!-- START MOD16 add Favicon  -->
<link rel="icon" 
      type="image/png" 
      href="http://crm.capitalbroker.pl/favicon.png">
<!-- END MOD16 Changes -->
    <meta charset="utf-8">
    <meta http-equiv="X-UA-Compatible" content="IE=edge,chrome=1">
    <title><?php echo Format::htmlchars($title); ?></title>
    <meta name="description" content="System Capital Lead to technologia wspomagająca zarządzanie biznesem angażująca niewielkie finanse.">
    <meta name="keywords" content="Capitallead, CRM, Capitalbroker">
